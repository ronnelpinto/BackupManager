# The GUI for this project is built using Python 3 Tkinter library. You can read more about the same here - https://docs.python.org/3/library/tkinter.html
...
class MainWindow(Frame): # Main Frame class
    ...
    def invokeScheduler(self):  # invoke scheduler for the backup
        a=os.getcwd()
        acceptDir()
        createDB()
        os.chdir(a)
